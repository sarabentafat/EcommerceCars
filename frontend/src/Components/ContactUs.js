      ...
      <div className="flex w-full min-h-screen  justify-center items-center">
        <div className="flex flex-col mt-14 md:flex-row md:space-x-6 space-y-6 bg-zinc-100  w-full max-w-4xl p-8  text-white sm:p-12">
          ...
          <div className="flex flex-col justify-between space-y-8 ">
            <div className="div">
              <h1 className="text-4xl  text-yellow-600 tracking-wide">
                Contact Us
              </h1>

              <p className="pt-2 text-neutral-900  text-sm">
                Join our community of car enthusiasts and stay updated on the
            ...
            <div className="flex flex-col space-y-6">
              <div className="inline-flex items-center space-x-3">
                ...
                <span className="ml-2 text-lg text-neutral-900">
                  +(213) 673 5672 43
                </span>
              </div>
            ...
            <div className=" flex  space-x-4">
              <a href="/">
                {" "}
                <FaFacebookSquare className="w-6 h-6 text-yellow-600" />
              </a>
              <a href="/">
                {" "}
              ...
              <a href="/">
                {" "}
                <FaLinkedin className="w-6 h-6 text-yellow-600" />
              </a>
            </div>
          </div>
