    ...
    <div className="bg-gray-100 p-10 font-serif  text-gray-900">
      <div className="bg-gray-200 bg-opacity-75 p-8 rounded-md">
        ...
        <div className="text-gray-900 flex justify-center items-center  text-xl font-serif mt-52 pb-8 text-center">
          <p>
            Trouvez la voiture qui correspond à vos préférences avec une
            qualité <br className="mb-2" />excellente et un large éventail de choix.
          </p>
        </div>
        ...
        <img
          src={Car}
          className="mx-auto mt-20 w-100 h-72"
          alt="Car Image"
        />
        ...
        <div className="flex mt-20 ">
          {/* First Column */}
          <div className="w-1/2 pr-6 ml-8 mt-3">
            ...
            <ul>
              <li>
                <input type="checkbox" className="mr-2  cursor-pointer focus:ring-yellow-800
                " />
                <label> BMW</label>
              </li>
              <li> 
                <input type="checkbox" className="mr-2 rounded-full   cursor-pointer" />
                <label>AUDI</label>
              </li>
              <li>
              <input type="checkbox" className="mr-2 rounded-full   cursor-pointer" />
              ...
              <li>  <input type="checkbox" className="mr-2 rounded-full   cursor-pointer" />
                <label>Autre</label></li>
            </ul>
          ...
          {/* Second Column */}
          <div className="w-1/2 pl-4 mr-20">
            <div className="flex bg-gray-200 p-4 rounded-md text-xl ">
              <div className="flex-1 text-center cursor-pointer hover:bg-black hover:text-white
              border border-black
              py-3">
                Car
              </div>
            ...
            <div className="flex mt-4">
              ...
              <div className="flex-1 ml-5">
                ...
                <p className="text-yellow-600 text-base  pb-3">300 Millions</p>
                <button className="bg-black text-white py-1 px-6">See Details</button>
              </div>
              <div className="flex-1 ml-5">
                <div className="relative">
                <HeartButton className="absolute top-0 right-0 mt-2 mr-2 " />
            ...
            {/* Button at the end */}
            <button className="bg-gray-200 border border-black border-opacity-92 text-black px-8 py-2  ml-56 my-14   ">
            load more
          </button>
          </div>
        </div>
